...
public class CreateProjectException extends Exception{
	...
	private static final long serialVersionUID = -6218340741353954451L;
	 ...
	 */
	public CreateProjectException(String exceptionCode, String exceptionMessage, String exceptionDetails) {
		this.exceptionCode = exceptionCode;
	    this.exceptionMessage = exceptionMessage;
	    this.exceptionDetails = exceptionDetails;
	}
