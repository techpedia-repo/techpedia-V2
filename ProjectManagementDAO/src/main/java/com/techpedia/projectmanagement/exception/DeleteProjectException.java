...
public class DeleteProjectException extends Exception {
	...
	private static final long serialVersionUID = -4718133667049621131L;
	 ...
	 * 
	 */
	public DeleteProjectException(String exceptionCode, String exceptionMessage, String exceptionDetails) {
		this.exceptionCode = exceptionCode;
	    this.exceptionMessage = exceptionMessage;
	    this.exceptionDetails = exceptionDetails;
	}
