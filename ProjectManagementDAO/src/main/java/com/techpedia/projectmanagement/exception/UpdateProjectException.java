...
public class UpdateProjectException extends Exception {
	...
	private static final long serialVersionUID = 7602950724471250210L;
	 ...
	 */
	public UpdateProjectException(String exceptionCode, String exceptionMessage, String exceptionDetails) {
		this.exceptionCode = exceptionCode;
	    this.exceptionMessage = exceptionMessage;
	    this.exceptionDetails = exceptionDetails;
	}
