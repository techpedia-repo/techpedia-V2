...
public class UserFunctionsNotDefinedException extends Exception 
{
	...
	public UserFunctionsNotDefinedException(String exceptionCode,
	...
	public UserFunctionsNotDefinedException(String exceptionMessage) {
		super();
		this.exceptionMessage = exceptionMessage;
	}
