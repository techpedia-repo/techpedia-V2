...
public class UniversitiesFetchException extends Exception{

	public UniversitiesFetchException(String msg)
	{
		super(msg);
	}
	 ...
	 */
	public UniversitiesFetchException(String exceptionCode,
