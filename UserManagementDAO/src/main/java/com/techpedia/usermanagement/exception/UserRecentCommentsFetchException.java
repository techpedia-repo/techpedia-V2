package com.techpedia.usermanagement.exception;
	...
	public class UserRecentCommentsFetchException extends Exception{

		  public UserRecentCommentsFetchException()
		    {
		    }

		    public UserRecentCommentsFetchException(String msg)
		    {
		        super(msg);
		    }
			 ...
			 */
			public UserRecentCommentsFetchException(String exceptionCode,
