...
public class UserRoleNotMappedWithFunctionIdsException extends Exception 
{
	...
	public UserRoleNotMappedWithFunctionIdsException(String exceptionCode,
	...
	public UserRoleNotMappedWithFunctionIdsException(String exceptionMessage) {
		super();
		this.exceptionMessage = exceptionMessage;
	}
